...
class TestImageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $images = [
            [
                'image_url_original' => 'FX-4300 1(1).png', 
            ...
            [
                'image_url_original' => 'FX-4300 2(1).png',
            ...
            [
                'image_url_original' => 'FX-4300 3(1).png',
            ...
            [
                'image_url_original' => 'FX-4300 4(1).png',
            ...
            [
                'image_url_original' => 'FX-4300 5(1).png',
            ...
            [
                'image_url_original' => 'FX-4300 6(1).png',
            ...
            [
                'image_url_original' => 'FX-4300 7(1).png',
            ...
            [
                'image_url_original' => 'FX-4300 8(1).png',
            ...
            [
                'image_url_original' => 'FX-4300 9(1).png',
