            ...
            <div>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center">
                        <button 
                            className=
                                {`rounded-md border flex justify-center items-center p-3 mr-2 
                                    ${wishlist.includes(product.id) ? 'bg-red-500 text-white' : 'border-slate-300 hover:border-orange-400'}`
                                }
